...
public:
    validation(std::ostream *result_stream, const std::string &output_file = "", bool debug_mode = false) : result_stream_(result_stream),
    ...
    {
        output_folder_ = binary_path + "../../output/benchmark_results_laptop/data/";
